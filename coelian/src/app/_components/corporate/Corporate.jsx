  ...
  return (
    ...
    >
           ...
           <div className="flex justify-center items-center md:p-4 p-2 ">
            <h1 className="font-mono font-extrabold text-[1.2rem] text-center md:text-[2rem]"><Trans i18nKey="pages.corporate.title"></Trans></h1>
           </div>
           ...
           <div className = "flex items-center justify-center border-2 bg-cover bg-center   relative rounded-lg opacity-80 overflow-hidden  " style={{
            ...
            <p className=" flex gap-2 flex-col justify-center items-center text-lg translate-y-16 text-white z-10 font-semibold" >
              <p><Trans i18nKey="pages.corporate.leftContent"></Trans></p> 
              <p className="text-center text-md">Our comprehensive search service specializes in finding the perfect office spaces for your business, ensuring a seamless transition into your new location.</p>
              <button className=" bg-[#b7a16e] rounded-md w-[100px]"><Trans i18nKey="pages.corporate.listing"></Trans> (1)</button>
              </p>
            </div>
           ...
           <div className="relative border-2 flex items-center justify-center bg-cover bg-center rounded-lg  opacity-80  overflow-hidden" style={{
            ...
            <div className="absolute w-full h-full bg-black/40 flex justify-center items-center ">
            <p className=" flex gap-2 flex-col justify-center items-center text-lg translate-y-16 text-white z-10 font-semibold" >
              <p><Trans i18nKey="pages.corporate.rightContent"></Trans></p> 
              <p className="text-center">
              <p className="text-md"> 
              For retailers, we provide expert store location assistance to help you find the ideal spot to showcase your brand. 
              </p>
                <p className="text-md">
