        ...
        <div className="grid grid-rows-1 lg:grid-cols-2    justify-center items-center overflow-hidden  ">
          <div className="bg-[#c6cedb]  order-2 md:h-[80vh]  flex sm:flex-col  justify-center p-10  items-center">
            ...
            >
              ...
              <p>
                <Trans i18nKey="pages.individual.title.p2"></Trans>
              </p>
              <p>
          ...
          <div className="  overflow-hidden relative md:h-[100vh], flex justify-center items-center">
            ...
            <div className="flex  justify-between mt-2">
              <button
                ...
                className="bg-[rgba(255,255,255,0.45)] shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-20 rounded-[20px] border border-[rgba(255,255,255,0.18)] absolute z-50 left-0 text-white px-4 py-2 "
              >
                <FaAngleLeft />
              </button>
              ...
              <button
                ...
                className="bg-[rgba(255,255,255,0.45)] shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-20 rounded-[20px] border border-[rgba(255,255,255,0.18)] absolute z-50 right-0 text-white px-4 py-2"
              >
                <FaAngleRight />{" "}
              </button>
            </div>
